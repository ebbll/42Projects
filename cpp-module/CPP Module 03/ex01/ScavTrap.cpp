...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/24 17:38:49 by eunlee            #+#    #+#             */
/*   Updated: 2022/03/25 19:07:37 by eunlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ScavTrap::attack(const std::string& target)
{
	if (_hitPoints == 0)
	{
		std::cout << "Attack failed! (Scavtrap " 
		<< _name << " is already dead)" << std::endl;
		return ;
	}
	if (_energyPoints == 0)
	{
		std::cout << "Attack failed! (lack of energy points)"
		<< std::endl;
		return ;
	}
	--_energyPoints;
