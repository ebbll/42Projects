...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/03/22 22:57:38 by eunlee            #+#    #+#             */
/*   Updated: 2022/03/27 16:17:56 by eunlee           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		_hitPoints = 0;
		std::cout << "ClapTrap " << _name << " died at this moment!" << std::endl;
	}
}
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	if (_hitPoints == 0)
	{
		std::cout << "Reparing ClapTrap " << _name
...
{
	std::cout << "[System] Status of ClapTrap " << _name << std::endl;
